...
const staleCart = [{ product_id: 'prod-1', variant_id: null, product_name: 'Chicken', variant_name: null, sku: 'CH', quantity: 1, unit_price: 80, subtotal: 80 }];
const refreshedCart = applyLiveCartPrices(staleCart, { [cartLineKey('prod-1', null)]: 90 });
