    ...
    mutation.mutate(
      {
        ...
        is_active: branch.is_main_branch ? true : values.is_active,
        ...
        <PageHeader
          ...
          subtitle={
            branch.is_main_branch
              ? 'The Main Branch cannot be deactivated or converted.'
              : 'Use inactive status instead of deleting a branch.'
          }
        />
        <BranchForm
          defaultValues={{
          ...
          hideMainToggle
          protectMainBranch={branch.is_main_branch}
