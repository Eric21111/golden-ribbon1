-- Main Branch Manager can add stock again after the first opening.
-- First receipt stays opening_stock; later receipts are adjustments so
-- the one-opening-per-product ledger rule and reconciliation stay intact.
